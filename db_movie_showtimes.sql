...
CREATE TABLE `showtimes` (
  ...
  CONSTRAINT `showtimes_theater_id_foreign` FOREIGN KEY (`theater_id`) REFERENCES `theaters` (`theater_id`) ON DELETE CASCADE
...
INSERT INTO `showtimes` VALUES (1,2,1,'2024-10-24','20:00:00',100,'2024-10-23 09:02:00','2024-10-23 09:15:19');
...
-- Dump completed on 2024-10-24  1:21:07
