                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('management.showtime.store') }}" method="POST">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">Fill out the details below to insert the showtime in the website</p>
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="mt-2">
                                        <select name="theater_id" id="theater_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" onchange="updateAvailableSeats()">
                                            @foreach($theaters as $theater)
                                                <option value="{{ $theater->theater_id }}" data-capacity="{{ $theater->capacity }}">{{ $theater->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="date" name="show_date" id="show_date" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="time" name="show_time" id="show_time" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="number" name="available_seats" id="available_seats" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" readonly>
                                    </div>
