        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('management.showtime.edit', $showtime->showtime_id) }}" class="inline-block bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                        Edit
                    </a>
                    <form action="{{ route('management.showtime.destroy', $showtime->showtime_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this showtime?');">
                        @csrf
                        @method('DELETE')
