                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-3">
                                    <label for="title"
                                        class="block text-sm font-medium leading-6 text-gray-900">Movie Title</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-3">
                                    <label for="duration"
                                        class="block text-sm font-medium leading-6 text-gray-900">Duration (In
                                        Minutes)</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-3">
                                    <label for="releaseDate"
                                        class="block text-sm font-medium leading-6 text-gray-900">Release Date</label>
                                    <div class="mt-2">
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="description" id="description" rows="4" value="{{ $movie->description }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 resize-y">
